...
@interface RVRepositoryViewController : IDEViewController <IDEOrganizerSource, DVTReplacementViewDelegate>
{
    ...
    IDENavigatorDataCell *_prototypeRepositoryCell;
    IDENavigatorDataCell *_prototypeGitRepositoryCell;
    IDENavigatorDataCell *_prototypeLocationCell;
    IDENavigatorDataCell *_prototypeWorkingCopyCell;
...
+ (void)initialize;
@property(retain) IDENavigableItem *selectedRootNavigable; // @synthesize selectedRootNavigable=_selectedRootNavigable;
@property(retain) IDESourceControlTree *selectedTree; // @synthesize selectedTree=_selectedTree;
@property(copy, nonatomic) NSArray *selectedObjects; // @synthesize selectedObjects=_selectedObjects;
- (BOOL)splitView:(id)arg1 shouldAdjustSizeOfSubview:(id)arg2;
- (double)splitView:(id)arg1 constrainMaxCoordinate:(double)arg2 ofSubviewAt:(long long)arg3;
- (double)splitView:(id)arg1 constrainMinCoordinate:(double)arg2 ofSubviewAt:(long long)arg3;
...
- (void)replacementView:(id)arg1 didInstallViewController:(id)arg2;
- (void)selectRepositoryForBranchingSetup:(id)arg1;
...
@interface RVStructureViewController : IDEViewController <DVTReplacementViewDelegate>
{
    ...
    DVTMapTable *_observationTokenByOperation;
    id <DVTObservingToken> _statusToken;
    id <RVStructureViewDelegate> _delegate;
    IDENavigatorDataCell *_prototypeCell;
    IDENavigatorDataCell *_prototypeBranchCell;
    IDENavigatorDataCell *_prototypeRemoteCell;
    IDENavigatorDataCell *_prototypeWorkingItemCell;
}

+ (id)keyPathsForValuesAffectingSelectedObject;
+ (id)defaultViewNibName;
+ (void)initialize;
@property(retain) id <RVStructureViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(copy) DVTMapTable *observationTokenByOperation; // @synthesize observationTokenByOperation=_observationTokenByOperation;
@property(copy) NSArray *draggedNodes; // @synthesize draggedNodes=_draggedNodes;
@property(retain) NSPredicate *scopePredicate; // @synthesize scopePredicate=_scopePredicate;
...
@property(retain) IDESourceControlNonEmptyTextField *textField; // @synthesize textField=_textField;
...
+ (id)defaultViewNibName;
+ (void)initialize;
@property(retain) RVStructureViewController *structureController; // @synthesize structureController=_structureController;
@property(retain) IDENavigableItem *rootNavigable; // @synthesize rootNavigable=_rootNavigable;
...
+ (id)defaultViewNibName;
+ (void)initialize;
@property(retain) IDESourceControlTreeItem *logItem; // @synthesize logItem=_logItem;
@property(retain) IDESourceControlRepository *sourceTree; // @synthesize sourceTree=_sourceTree;
- (void)replacementView:(id)arg1 willInstallViewController:(id)arg2;
- (void)updateBoundSourceTree;
...
@interface RVRepositoryLocation : NSObject
{
    ...
    NSArray *_branches;
    NSArray *_remotes;
    id <DVTInvalidation> _branchLoadingToken;
    id <DVTInvalidation> _remoteLoadingToken;
}
...
@property(retain) RVPeoplePickerContentViewController *currentVC; // @synthesize currentVC=_currentVC;
@property(retain, nonatomic) ABPerson *selectedPerson; // @synthesize selectedPerson=_selectedPerson;
...
@property(retain) id <RVPeoplePickerDelegate> pickerDelegate; // @synthesize pickerDelegate=_pickerDelegate;
...
@interface RVAddRepositoryWindowController : IDESourceControlRepositorySetupWindowController
{
...
@property(retain) IDESourceControlBranch *selectedStartingPoint; // @synthesize selectedStartingPoint=_selectedStartingPoint;
...
@interface RVRemotesViewController : IDEViewController <DVTReplacementViewDelegate>
{
    ...
    id <DVTInvalidation> _trackBranchCancellationToken;
}
