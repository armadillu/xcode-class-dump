...
@property(nonatomic) __weak IDEConfigurableDataNode *dataNode; // @synthesize dataNode=_dataNode;
- (void)dealloc;
...
@interface IDEBuildResultsOutlineLogic : NSObject
{
    ...
    id <DVTObservingToken> _activityLogObserver;
...
@property(readonly) IDEActivityLogSection *activityLog; // @synthesize activityLog=_activityLog;
- (BOOL)isEqual:(id)arg1;
