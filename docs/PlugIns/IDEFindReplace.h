...
@property id <IDEBatchFindResultGroupDelegate> delegate; // @synthesize delegate=_delegate;
...
@interface IDEBatchFindLocationsPopUpButtonCell : NSPopUpButtonCell
{
}
...
@interface IDEBatchFindResultSet : NSObject <NSCopying, IDEBatchFindResultSetProtocol>
{
...
@interface IDEBatchFindReplaceableSheetController : NSWindowController
{
    ...
    id <DVTObservingToken> _checkedItemsWatcher;
}
