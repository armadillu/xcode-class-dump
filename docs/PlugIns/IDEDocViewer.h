...
@property(retain, nonatomic) DSANode *displayedNode; // @synthesize displayedNode=_displayedNode;
...
@property(retain) IDEDocSetGetInfoTableView *summaryTableView; // @synthesize summaryTableView=_summaryTableView;
@property(nonatomic) BOOL showRevealInFinderButton; // @synthesize showRevealInFinderButton=_showRevealInFinderButton;
@property(copy, nonatomic) NSMutableArray *docSetProperties; // @synthesize docSetProperties=_docSetProperties;
@property(retain) DSADocSetUpdate *docSetUpdate; // @synthesize docSetUpdate=_docSetUpdate;
...
@interface IDEDocViewingPrefPaneController : IDEViewController <DSMDocSetLoaderListener, DSMDocSetSubscriptionListener, NSSplitViewDelegate>
{
    ...
    DVTMapTable *_clientTrackingTokens;
    DVTMapTable *_docSetUpdateStatusTokens;
    DVTGradientImageButton *_deleteButton;
    DVTGradientImageButton *_addButton;
    DVTGradientImageButton *_showInfoAreaButton;
    IDEDocDownloadsTableViewController *_downloadsTableViewController;
}

+ (id)keyPathsForValuesAffectingMinimumFontSizeString;
+ (int)validFontSizeForSize:(int)arg1;
@property(retain) NSTextView *docSetInfoTextView; // @synthesize docSetInfoTextView=_docSetInfoTextView;
@property(retain) DVTBorderedView *borderedViewAroundSplitView; // @synthesize borderedViewAroundSplitView=_borderedViewAroundSplitView;
@property(retain) DVTBorderedView *borderedViewBelowTable; // @synthesize borderedViewBelowTable=_borderedViewBelowTable;
@property(retain) NSButton *validateAddSubscriptionButton; // @synthesize validateAddSubscriptionButton=_validateAddSubscriptionButton;
@property(retain) NSTextField *subscriptionTextField; // @synthesize subscriptionTextField=_subscriptionTextField;
@property(retain) NSWindow *subscriptionWindow; // @synthesize subscriptionWindow=_subscriptionWindow;
@property(retain) NSButton *checkAndInstallNowButton; // @synthesize checkAndInstallNowButton=_checkAndInstallNowButton;
@property(retain) NSTextField *noUpdatesAvailableMessage; // @synthesize noUpdatesAvailableMessage=_noUpdatesAvailableMessage;
@property(retain) NSComboBox *minimumFontSizeControl; // @synthesize minimumFontSizeControl=_minimumFontSizeControl;
@property(retain) IDEDocDownloadsTableViewController *downloadsTableViewController; // @synthesize downloadsTableViewController=_downloadsTableViewController;
...
@property(retain) WebPreferences *webPreferences; // @synthesize webPreferences=_webPreferences;
...
@property(retain) DSANode *node; // @synthesize node=_node;
...
@property(retain) IDEDocOrganizerSource *organizerSource; // @synthesize organizerSource=_organizerSource;
@property(retain) DVTBorderedView *borderedView; // @synthesize borderedView=_borderedView;
@property(retain) IDENavigableItem *selectedNavigableItem; // @synthesize selectedNavigableItem=_selectedNavigableItem;
@property(retain) DVTReplacementView *replacementView; // @synthesize replacementView=_replacementView;
...
@property(retain) IDENavigableItemCoordinator *navItemCoordinator; // @synthesize navItemCoordinator=_navItemCoordinator;
@property(retain) DVTSplitView *splitView; // @synthesize splitView=_splitView;
@property(retain) DVTReplacementView *editorAreaReplacementView; // @synthesize editorAreaReplacementView=_editorAreaReplacementView;
@property(retain) DVTReplacementView *navigatorArea; // @synthesize navigatorArea=_navigatorArea;
- (void)commitStateToDictionary:(id)arg1;
- (void)revertStateWithDictionary:(id)arg1;
...
- (void)loadExploreNavigatorWithNode:(id)arg1 loadEditorArea:(BOOL)arg2;
@property(readonly) IDEEditorArea *editorArea;
...
+ (void)initialize;
@property(retain) DVTReplacementView *searchOptionsReplacementView; // @synthesize searchOptionsReplacementView=_searchOptionsReplacementView;
@property(retain) NSView *stackView; // @synthesize stackView=_stackView;
@property(retain) DVTBorderedView *searchResultsBorderedView; // @synthesize searchResultsBorderedView=_searchResultsBorderedView;
@property(retain) DVTBorderedView *searchOptionsBorderedView; // @synthesize searchOptionsBorderedView=_searchOptionsBorderedView;
@property(retain) DVTBorderedView *searchFieldBorderedView; // @synthesize searchFieldBorderedView=_searchFieldBorderedView;
@property(nonatomic) BOOL showsSearchOptions; // @synthesize showsSearchOptions=_showsSearchOptions;
@property(retain) IDEDocSearchResultsContext *resultsContext; // @synthesize resultsContext=_resultsContext;
@property(retain) IDEProgressSearchField *searchField; // @synthesize searchField=_searchField;
...
@property(retain) IDEDocSearchResultsOutlineView *resultsOutlineView; // @synthesize resultsOutlineView=_resultsOutlineView;
- (void)loadView;
...
@property(retain) IDEDocSearchOptionsController *searchOptionsController; // @synthesize searchOptionsController=_searchOptionsController;
...
@property(copy) NSString *searchString; // @synthesize searchString=_searchString;
@property(retain) IDENavigableItem *selectedItem; // @synthesize selectedItem=_selectedItem;
@property(retain) NSMutableDictionary *groupCells; // @synthesize groupCells=_groupCells;
@property(retain, nonatomic) IDENavigableItem *rootItem; // @synthesize rootItem=_rootItem;
- (void)outlineViewSelectionDidChange:(id)arg1;
...
@property(retain) IDEDocSearchResultsController *resultsController; // @synthesize resultsController=_resultsController;
...
@property unsigned long long resultsCount; // @synthesize resultsCount=_resultsCount;
...
@property(retain) IDEDocSearchResultsController *outlineViewController; // @synthesize outlineViewController=_outlineViewController;
...
@property(retain) IDENavigableItemCoordinator *navigableItemCoordinator; // @synthesize navigableItemCoordinator=_navigableItemCoordinator;
@property(retain) IDENavigableItem *selectedSampleCodeNode; // @synthesize selectedSampleCodeNode=_selectedSampleCodeNode;
...
{
    id _downloadObserver;
    DVTMapTable *_downloaderToObservers;
}
...
+ (id)distributionForGroupNavItems:(id)arg1 availableRows:(unsigned long long)arg2 totalResults:(unsigned long long)arg3 groupToAutoExpand:(id)arg4 outAutoExpandChildren:(id *)arg5;
...
@interface IDEDocDownloadsTableViewController : NSObject <_IDEComponentDownloadsButtonProvider>
{
...
@property(retain) DSADocSetUpdate *selectedDocSetUpdate; // @synthesize selectedDocSetUpdate=_selectedDocSetUpdate;
@property(retain) IDEDocViewingPrefPaneController *prefPaneController; // @synthesize prefPaneController=_prefPaneController;
- (void)tableViewSelectionDidChange:(id)arg1;
- (id)tableView:(id)arg1 toolTipForCell:(id)arg2 rect:(struct CGRect *)arg3 tableColumn:(id)arg4 row:(long long)arg5 mouseLocation:(struct CGPoint)arg6;
- (id)tableView:(id)arg1 dataCellForTableColumn:(id)arg2 row:(long long)arg3;
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forTableColumn:(id)arg3 row:(long long)arg4;
...
- (id)_downloadProblemCell;
- (id)_docSets;
- (void)refreshTable;
- (void)docSetUpdateDidChangeUpdateProgress:(id)arg1;
- (void)docSetUpdateDidChangeUpdateStatus:(id)arg1;
- (id)clickedItemInOutlineView;
- (void)awakeFromNib;

@end

@interface _DSAUpdateProgressValueTransformer : NSValueTransformer
{
}
...
@interface DSAToken (IDEDocSearchResults)
- (id)children;
@end
