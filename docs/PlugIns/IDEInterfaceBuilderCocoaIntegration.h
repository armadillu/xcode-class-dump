...
@interface IBNSToolbarConfigurationView : DVTLayoutView_ML
{
...
@property(retain) IBNSToolbarConfigurationView *configurationView; // @synthesize configurationView;
@property(retain) IBNSToolbarItemsContainerView *itemsContainerCounterpart; // @synthesize itemsContainerCounterpart;
...
@property(retain) id <IBBindingAutocompletingTextFieldDelegate> delegate; // @dynamic delegate;
...
@property(retain) CIFilter *selectedFilter; // @synthesize selectedFilter;
- (id)wrappedSelectedFilter;
@property(retain) NSIndexSet *filterSelectionIndexes; // @synthesize filterSelectionIndexes;
- (id)initWithOwner:(id)arg1 keyPath:(id)arg2;
